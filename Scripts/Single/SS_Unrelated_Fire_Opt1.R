##########################################################################################################################################
################# Fire Single Surface Optimization 1 #######################################################################################
##########################################################################################################################################
...
dir.create(file.path(paste(getwd(), "/Results/Single_Unrelated/", sep=""), "SS_Unrelated_Fire_Results_Opt1"))
...
fire <- c("Fire_density_final.asc")
ss.results.opt1 <- paste(getwd(), "/Results/Single_Unrelated/SS_Unrelated_Fire_Results_Opt1/", sep="")

file.copy(file.path(source.folder, fire), ss.results.opt1)

### STEP 8: Set directory to write results of first optimization

write.dir.opt1 <- paste(getwd(), "/Results/Single_Unrelated/SS_Unrelated_Fire_Results_Opt1/", sep="")
