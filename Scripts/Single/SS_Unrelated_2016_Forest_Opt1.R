##########################################################################################################################################
################# 2016 Forest Single Surface Optimization 1 #######################################################################################
##########################################################################################################################################
...
dir.create(file.path(paste(getwd(), "/Results/Single_Unrelated/", sep=""), "SS_Unrelated_2016_Forest_Results_Opt1"))
...
forest.2016 <- c("2016_forest_final.asc")
ss.results.opt1 <- paste(getwd(), "/Results/Single_Unrelated/SS_Unrelated_2016_Forest_Results_Opt1/", sep="")

file.copy(file.path(source.folder, forest.2016), ss.results.opt1)

### STEP 8: Set directory to write results of first optimization

write.dir.opt1 <- paste(getwd(), "/Results/Single_Unrelated/SS_Unrelated_2016_Forest_Results_Opt1/", sep="")
